  ...
  List<Color> get calendarColors {
    return switch (this) {
      ...
      DsCalendarColorOption.green => [
          const Color(0xff93EC14),
          const Color(0xff8dea11),
          const Color(0xff87E80D),
          const Color(0xff7CE407),
          const Color(0xff70E000),
          const Color(0xff69da00),
          const Color(0xff62D400),
          const Color(0xff5bce00),
          const Color(0xff54C800),
          const Color(0xff4DC200),
          const Color(0xff46BC00),
